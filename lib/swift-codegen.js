...
function addObjCMethodInfo (meta, method, modelName, skipOptionalArguments) {
  ...
  const objcReturnType = convertToObjCReturnType(returnType, modelName, meta.objcModelName);
  ...
  const successBlockType = convertToObjCSuccessBlockType(objcReturnType);
